This folder includes the files and information related to data processing stage and populating the full knowldge graph ([see workflow methdology diagram](Methdology_and_Scripts/workflow_methodology.svg)) for the entire state of Victoria, specifically: 
