...
The following queries assume this preamble. Note that in the latest version of [the visualisation dashboard](../VisualisationDashboard/vicmap_textbox.html) this preamble is hard-coded into the HTML. 
